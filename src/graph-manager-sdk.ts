...
export type OnGatewayVersionUpdatedSubscriptionVariables = Exact<{
  gatewayId: Scalars["ID"];
}>;

export type OnGatewayVersionUpdatedSubscription = {
  __typename?: "Subscription";
} & {
  gatewayVersionUpdated: { __typename?: "GatewayVersion" } & Pick<
    GatewayVersion,
    "id" | "status"
  > & {
      gateway: { __typename?: "Gateway" } & Pick<Gateway, "id" | "name"> & {
          currentVersion?: Maybe<
            { __typename?: "GatewayVersion" } & {
              serviceSchemas: Array<
                { __typename?: "ServiceSchema" } & Pick<
...
`;
export const OnGatewayVersionUpdatedDocument = gql`
...
export function getSdk(
  ...
  return {
    ...
    onGatewayVersionUpdated(
      variables: OnGatewayVersionUpdatedSubscriptionVariables
    ): Promise<OnGatewayVersionUpdatedSubscription> {
      return withWrapper(() =>
        client.request<OnGatewayVersionUpdatedSubscription>(
          print(OnGatewayVersionUpdatedDocument),
          variables
        )
      );
    },
