...
const JWT_SECRET = env_1.getENV('GRAPHQL_JWT_SECRET', undefined);
const JWT_PUBLIC_CERT = env_1.getENV('GRAPHQL_JWT_PUBLIC_CERT', undefined);
const JWT_CERTS_URL = env_1.getENV('GRAPHQL_JWT_CERTS_URL', undefined);
