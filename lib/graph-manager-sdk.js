...
exports.getSdk = exports.OnGatewayVersionUpdatedDocument = exports.PublishServiceSchemaDocument = exports.GetGatewayDocument = exports.GatewayVersionStatus = void 0;
...
`;
exports.OnGatewayVersionUpdatedDocument = graphql_tag_1.default `
...
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        ...
        onGatewayVersionUpdated(variables) {
            return withWrapper(() => client.request(graphql_1.print(exports.OnGatewayVersionUpdatedDocument), variables));
        },
    };
}
